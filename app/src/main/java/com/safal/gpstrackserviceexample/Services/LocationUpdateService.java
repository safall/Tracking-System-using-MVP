package com.safal.gpstrackserviceexample.Services;
...
import com.safal.gpstrackserviceexample.Utils.ApiUtils;
import com.safal.gpstrackserviceexample.Utils.Const;
import com.safal.gpstrackserviceexample.Utils.LocationVo;
import com.safal.gpstrackserviceexample.Utils.Post;
...
public class LocationUpdateService extends Service implements
    ...
    public void setLocationData() {
        if (!Const.isNetworkAvailable(this)) {
            Toast.makeText(this, "Latitude without internet: =" + mCurrentLocation.getLatitude() + " Longitude:=" + mCurrentLocation
...
//        mLocationData.add(mLocVo);
    ...
    private void updateUI() {
        ...
        float batteryPerc = (batteryPct * 100);

        String batteryNManu = "Battery Status:" + batteryPerc + "%";
        Log.d("batetry", batteryNManu + "");

        if (Const.isNetworkAvailable(this)) {
//            String address = Const.getCompleteAddressString(this, mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude());
            HashMap<String,String> params=new HashMap<>();
            params.put("DeviceId",manufacturer);
            params.put("LatLong",lat+" "+lng);
            params.put("DeviceIdentifier",model);
            params.put("AdditionalData",batteryNManu);
            sendPost(params);
        }
...
//        mLocationRequest.setSmallestDisplacement(10);
    ...
    public void sendPost(HashMap<String,String> params) {
        mAPIService.savePost(params).enqueue(new Callback<Post>() {
            @Override
